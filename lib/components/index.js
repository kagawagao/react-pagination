  ...
  (0, _createClass3.default)(Pagination, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { disabled: disabled, onClick: this.handeClick, className: disabled ? classPrefix + '-pagination-button ' + classPrefix + '-pagination-button-disabled' : classPrefix + '-pagination-button' },
          locale.jump
        )
      );
    }
